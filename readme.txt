...
= 3.0.1 - 2026-08-03 =
* Fix - Ensure the customer reports script is enqueued only on WooCommerce Admin (wc-admin) pages to avoid unnecessary asset loading elsewhere in wp-admin.
...
* Dev - Upgrade GitHub Actions workflows.
